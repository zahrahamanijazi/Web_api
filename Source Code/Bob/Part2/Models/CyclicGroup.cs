...
namespace Part2.Models
{
    public class CyclicGroup
    {
        ...
        public static List<int> FormCyclicGroup(int p)
        {
            ...
            //{
            //    generator = cyclicGroup[i];
            //    power_of_g = (PrimeNumber - 1) / 2;
            //    result = Math.Pow(generator, power_of_g);
            ...
            //        gen_list = gen_list + generator.ToString();
            //        count++;
            //    }
            //}

            //random = new Random().Next(0, Generators.Count);
            //g = Generators[0];
            ////return g;
